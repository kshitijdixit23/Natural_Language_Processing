...
for i in range (len(sentence)):
   ...
   words =  [stemmer.stem(word) for word in words if word.lower() not in set(stopwords.words("english"))] # If word is not found then move forward otherwise catch it & hrow it.
